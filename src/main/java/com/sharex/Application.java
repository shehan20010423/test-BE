...
public class Application {
    ...
    /**
     * Create and start the server health monitor for fault tolerance.
     * This monitors the health of all servers in the cluster.
     */
    @Bean
    public ServerHealthMonitor serverHealthMonitor(ClusterConfig clusterConfig) {
        ServerHealthMonitor monitor = new ServerHealthMonitor(clusterConfig);
        monitor.start();
        System.out.println("Server Health Monitor started - monitoring cluster health");
        return monitor;
    }
